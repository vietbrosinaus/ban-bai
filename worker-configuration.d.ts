/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: be17b2ebc166e28b7d31810e24ddf849)
// Runtime types generated with workerd@1.20260917.1 2025-09-01 nodejs_compat
interface __BaseEnv_Env {
	NEXT_PUBLIC_PARTY_HOST: string;
	Main: DurableObjectNamespace<import("./party/index").Table>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./party/index");
		durableNamespaces: "Table";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_PARTY_HOST">> {}
}
