...
const copy: Record<Language, Record<string, string>> = {
  vi: {
    ...
    heroEyebrow: "Bàn chơi dành cho hội bạn", heroTitle: "Bày bài ra bàn.\nMời bạn vào chơi.",
    heroIntro: "Mở phòng riêng, gửi một đường link và bắt đầu chơi. Dành cho những trò bài chúng ta đã cùng lớn lên.",
    availableGames: "Các trò chơi hiện có và sắp ra mắt", customGames: "+ trò chơi tùy biến", tamLive: "Tam Quốc Sát · trực tiếp",
    seatWaiting: "Ghế của bạn đang chờ", startPlaying: "Bắt đầu chơi", yourName: "Tên của bạn", namePlaceholder: "Ví dụ: Minh",
    chooseDeck: "Chọn bộ bài", classicCards: "Bài Tây", sandbox52: "Bộ bài tự do 52 lá", tamDeck: "Bộ bài chuẩn 108 lá",
    settingTable: "Đang dọn bàn…", createTable: "Tạo bàn chơi", joinFriends: "hoặc vào bàn của bạn bè", roomCode: "MÃ PHÒNG", joinRoom: "Vào phòng",
    ...
    updatingTable: "Đang cập nhật bàn…", loadingTable: "Đang tải bàn…", yourHand: "Bài trên tay", handHint: "Chọn một lá rồi đánh ngửa hoặc úp", chooseGenerals: "Chọn tướng",
    ...
    chooseTwoGenerals: "Chọn hai tướng", generalsDescription: "Lựa chọn của bạn được giữ kín với người khác cho đến khi bạn lật từng tướng.", selectedTwo: "Đã chọn {count}/2", useGenerals: "Dùng hai tướng này", hp: "HP",
  ...
  en: {
    ...
    heroEyebrow: "A table for your crew", heroTitle: "Cards on the table.\nFriends in the room.",
    heroIntro: "Open a private room, share one link, and start playing. Built for the card games we grew up with.",
    availableGames: "Available and planned games", customGames: "+ custom games", tamLive: "Tam Quốc Sát · live",
    seatWaiting: "Your seat is waiting", startPlaying: "Start playing", yourName: "Your name", namePlaceholder: "e.g. Minh",
    chooseDeck: "Choose a deck", classicCards: "Classic cards", sandbox52: "52-card sandbox", tamDeck: "108-card standard deck",
    settingTable: "Setting the table…", createTable: "Create a table", joinFriends: "or join your friends", roomCode: "ROOM CODE", joinRoom: "Join room",
    ...
    updatingTable: "Updating the table…", loadingTable: "Loading the table…", yourHand: "Your hand", handHint: "Choose a card, then play it face-up or face-down", chooseGenerals: "Choose generals",
    ...
    chooseTwoGenerals: "Choose two generals", generalsDescription: "Your choices stay hidden from other players until you reveal each card.", selectedTwo: "{count}/2 selected", useGenerals: "Use these generals", hp: "HP",
