...
const copy: Record<Language, Record<string, string>> = {
  vi: {
    ...
    moveMyHand: "Đưa về tay", drawToHand: "Rút về tay", playTop: "Đánh lá trên cùng ngửa", shufflePile: "Xáo chồng", flipPile: "Lật chồng", addSelected: "Thêm các lá đã chọn", spreadCards: "Trải bài", viewCardRule: "Luật / thông tin",
  ...
  en: {
    ...
    moveMyHand: "Move to my hand", drawToHand: "Draw to hand", playTop: "Play top face-up", shufflePile: "Shuffle pile", flipPile: "Flip pile", addSelected: "Add selected cards", spreadCards: "Spread cards", viewCardRule: "Rules / details",
