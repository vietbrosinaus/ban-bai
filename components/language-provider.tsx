...
const copy: Record<Language, Record<string, string>> = {
  vi: {
    ...
    live: "Trực tiếp", offline: "Ngoại tuyến", reconnecting: "Đang kết nối lại", connecting: "Đang kết nối", gameLog: "Nhật ký", openGameLog: "Mở nhật ký trận đấu", gameLogDescription: "Lịch sử 100 hoạt động gần nhất, kèm thời gian và người thực hiện.", noGameActivity: "Chưa có hoạt động nào.",
    tamMode: "Tam Quốc Sát · 108 lá", sandboxMode: "Bộ bài tự do 52 lá", fixedSeating: "Vị trí ngồi cố định quanh bàn",
    you: "Bạn", cards: "{count} lá", yourSeat: "{name}, chỗ ngồi của bạn", seat: "{name}, ghế {seat}",
    addTarget: "Chọn {name} làm mục tiêu", removeTarget: "Bỏ {name} khỏi mục tiêu", hiddenGeneral: "Tướng ẩn", noGeneral: "Chưa chọn tướng",
    faceDown: "Úp mặt", shareCircle: "Gửi link để mời thêm người vào bàn",
    sharedCanvas: "Mặt bàn chung", canvasHelp: "Kéo để chọn · Shift-bấm để chọn thêm · Chuột phải để thao tác", canvasAria: "Mặt bàn tự do dùng chung", cursorActivity_table: "đang xem bàn", cursorActivity_card: "đang xem bài", cursorActivity_pile: "đang xem chồng bài", cursorActivity_deck: "đang dùng bộ bài", cursorActivity_controls: "đang thao tác",
    drawFromDeck: "Rút bài, còn {count} lá", drawFromGeneralPile: "Rút tướng, còn {count} lá", tapDeck: "Bấm vào chồng bài để rút", deckHint: "Bấm để rút · Chuột phải để thao tác", discard: "Chồng bỏ",
    ...
    tableControls: "Điều khiển bàn", host: "Chủ phòng", cardsEach: "Mỗi người {count} lá", cardsPerPlayer: "Số lá mỗi người", deal: "Chia bài", dealToPlayers: "Chia bài cho người chơi", dealToPlayersDescription: "Chọn số lá cho mỗi người. Bàn sẽ được dọn và bộ bài sẽ được xáo lại trước khi chia.",
    ...
    deckActions: "Thao tác bộ bài", pileActions: "Thao tác chồng bài", cardActions: "Thao tác lá bài", selectedCardCount: "{count} lá đã chọn", makeFaceDownPile: "Tạo chồng úp", rotate15: "Xoay 15°", bringFront: "Đưa lên trên cùng",
    moveMyHand: "Đưa về tay", drawToHand: "Rút về tay", playTop: "Đánh lá trên cùng ngửa", shufflePile: "Xáo chồng", flipPile: "Lật chồng", addSelected: "Thêm các lá đã chọn", addSelectedToTop: "Thêm lên đầu chồng", addSelectedRandomly: "Chèn vào vị trí ngẫu nhiên", returnSelectedToDeck: "Trả lá đã chọn lên đầu bộ bài", returnSelectedRandomly: "Trả vào vị trí ngẫu nhiên", spreadCards: "Trải bài", viewCardRule: "Luật / thông tin",
    ...
    healthControls: "Điều khiển sinh lực", decreaseMaxHp: "Giảm sinh lực tối đa", increaseMaxHp: "Tăng sinh lực tối đa", max: "tối đa", leave: "Rời bàn",
    handEmpty: "Tay bạn đang trống", drawing: "Đang rút…", drawCard: "Rút một lá", play: "Đánh", giveTo: "Đưa cho…", give: "Đưa", cancelSelection: "Hủy chọn bài",
    ...
    cardRule: "Cách dùng", cardRuleNote: "Tóm tắt để tra nhanh. Nhóm của bạn có thể thống nhất luật riêng hoặc cách xử lý khác theo chế độ chơi.", generalDefinition: "Thông tin tướng", generalSkills: "Kỹ năng", generalRuleNote: "Nội dung kỹ năng dùng để tra nhanh theo bộ luật Tam Quốc Sát tiêu chuẩn.", generalRuleEnglishNote: "Skill wording is currently shown in authoritative Vietnamese.", faction_wei: "Ngụy", faction_shu: "Thục", faction_wu: "Ngô", faction_qun: "Quần Hùng", "cardCategory_basic": "Bài cơ bản", "cardCategory_trick": "Cẩm nang", "cardCategory_delayed-trick": "Cẩm nang trì hoãn", "cardCategory_weapon": "Vũ khí", "cardCategory_armor": "Phòng cụ", "cardCategory_mount": "Tọa kỵ",
    ...
    counterValue: "{label}, giá trị {value}", actionsFor: "Thao tác với {name}", kickPlayer: "Mời {name} rời bàn", kickPlayerTitle: "Mời người chơi rời bàn?", kickPlayerDescription: "{name} sẽ bị đưa khỏi phòng. Bài riêng của họ sẽ được xáo lại vào đúng chồng bài.", kickPlayerConfirm: "Mời rời bàn", playerKicked: "Đã mời {name} rời bàn.", cancel: "Hủy", close: "Đóng",
  },
  en: {
    ...
    live: "Live", offline: "Offline", reconnecting: "Reconnecting", connecting: "Connecting", gameLog: "Game log", openGameLog: "Open game activity log", gameLogDescription: "The latest 100 activities, including when they happened and who performed them.", noGameActivity: "No activity yet.",
    tamMode: "Tam Quốc Sát · 108 cards", sandboxMode: "52-card sandbox", fixedSeating: "Fixed table seating",
    you: "You", cards: "{count} card(s)", yourSeat: "{name}, your seat", seat: "{name}, seat {seat}",
    ...
    faceDown: "Face down", shareCircle: "Share the link to fill the circle",
    sharedCanvas: "Shared canvas", canvasHelp: "Drag to select · Shift-click to add · Right-click for actions", canvasAria: "Shared freeform tabletop canvas", cursorActivity_table: "viewing the table", cursorActivity_card: "checking a card", cursorActivity_pile: "checking a pile", cursorActivity_deck: "using the deck", cursorActivity_controls: "using controls",
    drawFromDeck: "Draw from deck, {count} cards remaining", drawFromGeneralPile: "Draw a general, {count} cards remaining", tapDeck: "Tap deck to draw", deckHint: "Click to draw · Right-click for actions", discard: "Discard",
    ...
    tableControls: "Table controls", host: "Host", cardsEach: "{count} cards each", cardsPerPlayer: "Cards per player", deal: "Deal", dealToPlayers: "Deal to players", dealToPlayersDescription: "Choose how many cards each player receives. The table is cleared and the deck is reshuffled before dealing.",
    ...
    deckActions: "Deck actions", pileActions: "Pile actions", cardActions: "Card actions", selectedCardCount: "{count} selected cards", makeFaceDownPile: "Make face-down pile", rotate15: "Rotate 15°", bringFront: "Bring to front",
    moveMyHand: "Move to my hand", drawToHand: "Draw to hand", playTop: "Play top face-up", shufflePile: "Shuffle pile", flipPile: "Flip pile", addSelected: "Add selected cards", addSelectedToTop: "Add to top of pile", addSelectedRandomly: "Insert at random positions", returnSelectedToDeck: "Return selected to top of deck", returnSelectedRandomly: "Return at random positions", spreadCards: "Spread cards", viewCardRule: "Rules / details",
    ...
    healthControls: "Health controls", decreaseMaxHp: "Decrease maximum health", increaseMaxHp: "Increase maximum health", max: "max", leave: "Leave",
    handEmpty: "Your hand is empty", drawing: "Drawing…", drawCard: "Draw a card", play: "Play", giveTo: "Give to…", give: "Give", cancelSelection: "Cancel card selection",
    ...
    cardRule: "How to use", cardRuleNote: "A quick-reference summary. Your group may agree on house rules or mode-specific rulings.", generalDefinition: "General details", generalSkills: "Skills", generalRuleNote: "Skill text is provided as a quick reference for the standard Tam Quốc Sát ruleset.", generalRuleEnglishNote: "Skill wording is currently shown in authoritative Vietnamese.", faction_wei: "Wei", faction_shu: "Shu", faction_wu: "Wu", faction_qun: "Independent", "cardCategory_basic": "Basic card", "cardCategory_trick": "Trick", "cardCategory_delayed-trick": "Delayed trick", "cardCategory_weapon": "Weapon", "cardCategory_armor": "Armor", "cardCategory_mount": "Mount",
    ...
    counterValue: "{label}, value {value}", actionsFor: "Actions for {name}", kickPlayer: "Remove {name} from the table", kickPlayerTitle: "Remove this player?", kickPlayerDescription: "{name} will be removed from the room. Their private cards will be shuffled back into the correct deck.", kickPlayerConfirm: "Remove player", playerKicked: "Removed {name} from the table.", cancel: "Cancel", close: "Close",
  },
};
...
export function localizeServerText(text: string, language: Language) {
  ...
  const exact: Record<string, string> = {
    ...
    "Only the host can do that.": "Chỉ chủ phòng mới có thể thực hiện thao tác này.",
    "You cannot remove yourself from the table.": "Bạn không thể tự đưa mình khỏi bàn.",
    "That player is no longer at the table.": "Người chơi đó không còn ở bàn.",
    ...
    "Select cards to return to the deck.": "Chọn lá muốn trả lại bộ bài.",
    "Return general cards to the general pile.": "Hãy trả lá Tướng về chồng Tướng.",
  ...
  const patterns: Array<[RegExp, (...parts: string[]) => string]> = [
    ...
    [/^(.+) removed (.+) from the table$/, (name, target) => `${name} đã mời ${target} rời bàn`],
    ...
    [/^(.+) returned (\d+) cards? to the top of the deck$/, (name, count) => `${name} đã trả ${count} lá lên đầu bộ bài`],
    [/^(.+) returned (\d+) cards? randomly into the deck$/, (name, count) => `${name} đã trả ${count} lá vào vị trí ngẫu nhiên trong bộ bài`],
    ...
    [/^(.+) adjusted a card on the canvas$/, (name) => `${name} đã điều chỉnh một lá trên bàn`],
    [/^(.+) adjusted (\d+) cards on the canvas$/, (name, count) => `${name} đã điều chỉnh ${count} lá trên bàn`],
    [/^(.+) stacked (\d+) cards into a pile$/, (name, count) => `${name} đã xếp ${count} lá thành chồng`],
    [/^(.+) added (\d+) cards? to the top of (.+)$/, (name, count, pile) => `${name} đã thêm ${count} lá lên đầu ${pile}`],
    [/^(.+) added (\d+) cards? randomly into (.+)$/, (name, count, pile) => `${name} đã chèn ${count} lá vào vị trí ngẫu nhiên trong ${pile}`],
    [/^(.+) drew from (.+)$/, (name, pile) => `${name} đã rút từ ${pile}`],
    [/^(.+) played from (.+)$/, (name, pile) => `${name} đã đánh lá trên cùng từ ${pile}`],
    [/^(.+) shuffled (.+)$/, (name, pile) => `${name} đã xáo ${pile}`],
    [/^(.+) flipped (.+)$/, (name, pile) => `${name} đã lật ${pile}`],
    [/^(.+) spread (.+)$/, (name, pile) => `${name} đã trải ${pile}`],
    [/^(.+) discarded (.+)$/, (name, item) => `${name} đã bỏ ${item}`],
    [/^(.+) played (.+)$/, (name, card) => `${name} đã đánh ${card}`],
    [/^(.+) equipped (.+)$/, (name, card) => `${name} đã trang bị ${card}`],
    [/^(.+) placed (.+) in the delayed-trick zone$/, (name, card) => `${name} đã đặt ${card} vào vùng phán xét`],
    [/^(.+) gave a card to (.+)$/, (name, target) => `${name} đã đưa một lá cho ${target}`],
    [/^(.+) retrieved (.+) from discard$/, (name, card) => `${name} đã lấy ${card} từ chồng bỏ`],
    [/^(.+) took back a card$/, (name) => `${name} đã lấy lại một lá`],
    [/^(.+) set max health to (\d+)$/, (name, value) => `${name} đã đặt sinh lực tối đa thành ${value}`],
    [/^(.+) set health to (\d+)$/, (name, value) => `${name} đã đặt sinh lực thành ${value}`],
    [/^(.+) is chained$/, (name) => `${name} đã vào trạng thái xích`],
    [/^(.+) is face down$/, (name) => `${name} đã úp mặt`],
    [/^(.+) is upright$/, (name) => `${name} đã trở lại bình thường`],
    [/^(.+) targeted (.+)$/, (name, target) => `${name} đã chọn ${target} làm mục tiêu`],
    [/^(.+) untargeted (.+)$/, (name, target) => `${name} đã bỏ chọn mục tiêu ${target}`],
    [/^(.+) cleared their targets$/, (name) => `${name} đã bỏ tất cả mục tiêu`],
    [/^(.+) set (.+) to (-?\d+)$/, (name, item, value) => `${name} đã đặt ${item} thành ${value}`],
