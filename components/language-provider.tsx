...
const copy: Record<Language, Record<string, string>> = {
  vi: {
    ...
    moveMyHand: "Đưa về tay", drawToHand: "Rút về tay", playTop: "Đánh lá trên cùng ngửa", shufflePile: "Xáo chồng", flipPile: "Lật chồng", addSelected: "Thêm các lá đã chọn", spreadCards: "Trải bài", viewCardRule: "Xem luật",
    ...
    cardRule: "Cách dùng", cardRuleNote: "Tóm tắt để tra nhanh. Nhóm của bạn có thể thống nhất luật riêng hoặc cách xử lý khác theo chế độ chơi.", "cardCategory_basic": "Bài cơ bản", "cardCategory_trick": "Cẩm nang", "cardCategory_delayed-trick": "Cẩm nang trì hoãn", "cardCategory_weapon": "Vũ khí", "cardCategory_armor": "Phòng cụ", "cardCategory_mount": "Tọa kỵ",
  ...
  en: {
    ...
    moveMyHand: "Move to my hand", drawToHand: "Draw to hand", playTop: "Play top face-up", shufflePile: "Shuffle pile", flipPile: "Flip pile", addSelected: "Add selected cards", spreadCards: "Spread cards", viewCardRule: "View rule",
    ...
    cardRule: "How to use", cardRuleNote: "A quick-reference summary. Your group may agree on house rules or mode-specific rulings.", "cardCategory_basic": "Basic card", "cardCategory_trick": "Trick", "cardCategory_delayed-trick": "Delayed trick", "cardCategory_weapon": "Weapon", "cardCategory_armor": "Armor", "cardCategory_mount": "Mount",
